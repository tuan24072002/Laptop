              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${
                    location.pathname.slice(1) === item.id
        ...
        ${isSearchOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
            ...
            {appState.user ? (
              <div className="relative group">
                ...
                <ul
                  className={cn(
                    "absolute top-10 right-0 bg-background shadow border border-gray-200 w-40 py-2.5 rounded-md text-sm z-40",
                    openDropdown ? "block" : "hidden group-hover:block"
                  )}
                >
                  <li className="p-1.5 pl-3 text-sm text-accent-foreground">
                    Xin chào,{" "}
