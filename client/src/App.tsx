    ...
    <CartProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <main>
          {/* {renderCurrentPage()} */}
          <Routes>
            <Route path="/" element={<HomePage onProductView={handleProductView} />} />
            <Route path="/products" element={<ProductsPage onProductView={handleProductView} />} />
      ...
      {authState.showEmailVerification && !appState.user?.isVerified && <Verify />}
      <Toaster />
    </CartProvider>
  );
}
